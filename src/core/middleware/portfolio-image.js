...
const UploadPortfolioImageMiddleware = async (req, res, next) => {
    upload.single('portfolio')(req, res, async (err) => {
        if (err) {
...
export const deletePortfolioImage = (filename) => {
    try {
...
export const servePortfolioImage = (filename) => {
    const filePath = path.join(UPLOAD_DIR, filename);
...
export default UploadPortfolioImageMiddleware;